        ...
        <div class="item">
          <img src="../images/Farm3HomePic1.jpg">
           <div class="carousel-caption">
            ...
            <p>After the battling and triumphing the recession, this family owned farm has grown together. This farm treats its chickens as part of the family. Check out the hens here, and maybe the owners!  <a class="label label-primary" href="../Farms/Farm3Controller" target="_blank">Farm3</a></p>
          </div>
        </div><!-- End Item -->
