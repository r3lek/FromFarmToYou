            ...
            <table class="table table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <div class="media">
                            ...
                            <div class="media-body">
                                ...
                                <h5 class="media-heading"> by <a href="#">${entry.name}</a></h5>
                        ...
                        <button type="button" class="btn btn-danger">
                           <a href = "DeleteEgg?id=${entry.id}">Delete </a> <!-- Works, now implement controller -->
                        </button></form></td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td class="text-right"><h5><strong>${sessionScope.totalSum}</strong></h5></td>
                    </tr>
                    <tr>
                        <td>   </td>
                        <td>   </td>
                    ...
                    <tr>
                        ...
                        <td>
                        <form >
                        <button type="submit" class="btn btn-default" formaction = "${sessionScope.previousURL}">
                            <span class="glyphicon glyphicon-shopping-cart"></span> Continue Shopping
                        </button></form></td>
                        <td>
                        <form>
                        <button type="submit" class="btn btn-success" formaction = "ShippingLabel">
