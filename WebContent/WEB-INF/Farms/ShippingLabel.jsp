...
<div class="container">
  <center><h2>Shipping Label</h2></center>
<!--   <hr>
  ...
  <form class="form-horizontal" action="getLabel" method="post">
   ...
   <form class="form-horizontal" action="getLabel" method="post">
   <hr>
   <p><H3>Enter Customer Information</H3>
   ...
   <div class="form-group">
    ...
    <div class="form-group">
      <div class="col-sm-3"><label>Zip/Postal Code</label><input type="text" class="form-control" placeholder="Zip/Postal code" name="zip"></div>
      <div class="col-sm-3"><label>Country</label><input type="text" class="form-control" placeholder="United States" value="United States"></div>
      <div class="col-sm-3"><label>State</label><input type="text" class="form-control" placeholder="State" name="state"></div>
    </div>
    <hr>
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        ...
                        <div class="row ">
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-3">
                                <img src="https://d30y9cdsu7xlg0.cloudfront.net/png/3994-200.png" height = "75px" width = "50px" class="img-rounded" />
                            </div>
                        </div>
                        <div class="row ">
...
<center><input type="submit" value="Create Shipping Label"></center>
</form>
